...
.method private handleBindService(Landroid/app/ActivityThread$BindServiceData;)V
    ...
    iget-object v10, p1, Landroid/app/ActivityThread$BindServiceData;->token:Landroid/os/IBinder;
    ...
    .line 2901
    .local v6, "s":Landroid/app/Service;
    if-eqz v6, :cond_1
    ...
    invoke-virtual {v7, v10}, Landroid/content/Intent;->setExtrasClassLoader(Ljava/lang/ClassLoader;)V
    ...
    invoke-virtual {v6, v7}, Landroid/app/Service;->onBind(Landroid/content/Intent;)Landroid/os/IBinder;
    ...
    const-string v11, "ActivityThread service.onBind() delay:"
    ...
    const-string/jumbo v11, "ms service:"
    ...
    iget-object v11, p1, Landroid/app/ActivityThread$BindServiceData;->intent:Landroid/content/Intent;

    invoke-interface {v7, v10, v11, v0}, Landroid/app/IActivityManager;->publishService(Landroid/os/IBinder;Landroid/content/Intent;Landroid/os/IBinder;)V
    ...
    invoke-virtual {v6, v7}, Landroid/app/Service;->onRebind(Landroid/content/Intent;)V
    ...
    const-string v11, "ActivityThread service.onRebind() delay:"
    ...
    invoke-interface {v7, v10, v11, v12, v13}, Landroid/app/IActivityManager;->serviceDoneExecuting(Landroid/os/IBinder;III)V
    :try_end_1
    ...
    invoke-virtual {v7, v6, v1}, Landroid/app/Instrumentation;->onException(Ljava/lang/Object;Ljava/lang/Throwable;)Z
    ...
    const-string v11, "Unable to bind to service "
...
.method private handleCreateService(Landroid/app/ActivityThread$CreateServiceData;)V
    ...
    .line 2877
    .local v10, "delay":J
    sget v4, Landroid/os/NubiaDebug;->SERVICE_DELAY:I
    ...
    const-string v6, "ActivityThread service.onCreate() delay:"
    ...
    const-string/jumbo v6, "ms service:"
...
.method private handleReceiver(Landroid/app/ActivityThread$ReceiverData;)V
    ...
    .line 2676
    .local v14, "packageInfo":Landroid/app/LoadedApk;
    invoke-static {}, Landroid/app/ActivityManagerNative;->getDefault()Landroid/app/IActivityManager;

    move-result-object v11

    .line 2680
    .local v11, "mgr":Landroid/app/IActivityManager;
    :try_start_0
    invoke-virtual {v14}, Landroid/app/LoadedApk;->getClassLoader()Ljava/lang/ClassLoader;
    ...
    invoke-virtual/range {v18 .. v18}, Landroid/content/Intent;->prepareToEnterProcess()V

    .line 2683
    move-object/from16 v0, p1

    invoke-virtual {v0, v5}, Landroid/app/ActivityThread$ReceiverData;->setExtrasClassLoader(Ljava/lang/ClassLoader;)V
    ...
    .line 2695
    .local v15, "receiver":Landroid/content/BroadcastReceiver;
    const/16 v18, 0x0
    ...
    invoke-virtual {v14, v0, v1}, Landroid/app/LoadedApk;->makeApplication(ZLandroid/app/Instrumentation;)Landroid/app/Application;
    ...
    invoke-virtual {v15, v0}, Landroid/content/BroadcastReceiver;->setPendingResult(Landroid/content/BroadcastReceiver$PendingResult;)V
    ...
    .line 2711
    .local v16, "start":J
    invoke-virtual {v7}, Landroid/app/ContextImpl;->getReceiverRestrictedContext()Landroid/content/Context;
    ...
    invoke-virtual {v15, v0, v1}, Landroid/content/BroadcastReceiver;->onReceive(Landroid/content/Context;Landroid/content/Intent;)V
    ...
    .line 2716
    .local v8, "delay":J
    sget v18, Landroid/os/NubiaDebug;->RECEIVER_DELAY:I
    ...
    .line 2717
    const-string/jumbo v18, "nubialog"

    new-instance v19, Ljava/lang/StringBuilder;

    invoke-direct/range {v19 .. v19}, Ljava/lang/StringBuilder;-><init>()V

    const-string v20, "ActivityThread onReceive() delay:"
    ...
    const-string/jumbo v20, "ms receiver:"
    ...
    .end local v16    # "start":J
    :goto_0
    invoke-virtual {v15}, Landroid/content/BroadcastReceiver;->getPendingResult()Landroid/content/BroadcastReceiver$PendingResult;
    ...
    .end local v15    # "receiver":Landroid/content/BroadcastReceiver;
    :catch_0
    move-exception v10
    ...
    invoke-virtual {v0, v11}, Landroid/app/ActivityThread$ReceiverData;->sendFinished(Landroid/app/IActivityManager;)V
    ...
    const-string v20, "Unable to instantiate receiver "
    ...
    .restart local v15    # "receiver":Landroid/content/BroadcastReceiver;
    :catch_1
    move-exception v10
    ...
    invoke-virtual {v0, v15, v10}, Landroid/app/Instrumentation;->onException(Ljava/lang/Object;Ljava/lang/Throwable;)Z
    ...
    const-string v20, "Unable to start receiver "
    ...
    sget-object v19, Landroid/app/ActivityThread;->sCurrentBroadcastIntent:Ljava/lang/ThreadLocal;
...
.method private handleServiceArgs(Landroid/app/ActivityThread$ServiceArgsData;)V
    ...
    iget-object v10, p1, Landroid/app/ActivityThread$ServiceArgsData;->token:Landroid/os/IBinder;
    ...
    iget v10, p1, Landroid/app/ActivityThread$ServiceArgsData;->flags:I

    iget v11, p1, Landroid/app/ActivityThread$ServiceArgsData;->startId:I

    invoke-virtual {v6, v7, v10, v11}, Landroid/app/Service;->onStartCommand(Landroid/content/Intent;II)I
    ...
    const-string v11, "ActivityThread service.onStartCommand() delay:"
    ...
    iget v12, p1, Landroid/app/ActivityThread$ServiceArgsData;->startId:I

    invoke-interface {v7, v10, v11, v12, v3}, Landroid/app/IActivityManager;->serviceDoneExecuting(Landroid/os/IBinder;III)V
    :try_end_1
    ...
    invoke-virtual {v6, v7}, Landroid/app/Service;->onTaskRemoved(Landroid/content/Intent;)V
    ...
    const-string v11, "ActivityThread service.onTaskRemoved() delay:"
    ...
    invoke-virtual {v7, v6, v2}, Landroid/app/Instrumentation;->onException(Ljava/lang/Object;Ljava/lang/Throwable;)Z
    ...
    iget-object v11, p1, Landroid/app/ActivityThread$ServiceArgsData;->args:Landroid/content/Intent;
    ...
    invoke-direct {v7, v10, v2}, Ljava/lang/RuntimeException;-><init>(Ljava/lang/String;Ljava/lang/Throwable;)V
...
.method private handleStopService(Landroid/os/IBinder;)V
    ...
    invoke-virtual {v10, p1}, Landroid/util/ArrayMap;->remove(Ljava/lang/Object;)Ljava/lang/Object;
    ...
    .line 3095
    .local v8, "start":J
    invoke-virtual {v6}, Landroid/app/Service;->onDestroy()V
    ...
    const-string v12, "ActivityThread service.onDestroy() delay:"
    ...
    const-string/jumbo v12, "ms service:"
    ...
    instance-of v10, v0, Landroid/app/ContextImpl;

    if-eqz v10, :cond_1

    .line 3105
    invoke-virtual {v6}, Landroid/app/Service;->getClassName()Ljava/lang/String;
    ...
    invoke-virtual {v0, v7, v10}, Landroid/app/ContextImpl;->scheduleFinalCleanup(Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-interface {v10, p1, v11, v12, v13}, Landroid/app/IActivityManager;->serviceDoneExecuting(Landroid/os/IBinder;III)V
    :try_end_1
    .catch Landroid/os/RemoteException; {:try_start_1 .. :try_end_1} :catch_0
    .catch Ljava/lang/Exception; {:try_start_1 .. :try_end_1} :catch_1
    ...
    const-string v12, "handleStopService: unable to execute serviceDoneExecuting for "
    ...
    invoke-static {v10, v11, v1}, Landroid/util/Slog;->i(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)I
    :try_end_2
    .catch Ljava/lang/Exception; {:try_start_2 .. :try_end_2} :catch_1
    ...
    invoke-virtual {v10, v6, v1}, Landroid/app/Instrumentation;->onException(Ljava/lang/Object;Ljava/lang/Throwable;)Z
    ...
    const-string v12, "Unable to stop service "
    ...
    const-string v12, "handleStopService: exception for "
    ...
    const-string v12, "handleStopService: token="
...
.method private handleUnbindService(Landroid/app/ActivityThread$BindServiceData;)V
    ...
    invoke-virtual {v6, v7}, Landroid/app/Service;->onUnbind(Landroid/content/Intent;)Z
    ...
    const-string v11, "ActivityThread service.onUnbind() delay:"
    ...
    invoke-interface {v7, v10, v11, v2}, Landroid/app/IActivityManager;->unbindFinished(Landroid/os/IBinder;Landroid/content/Intent;Z)V
    ...
    invoke-virtual {v7, v6, v3}, Landroid/app/Instrumentation;->onException(Ljava/lang/Object;Ljava/lang/Throwable;)Z
    ...
    const-string v11, "Unable to unbind to service "
    ...
    invoke-direct {v7, v10, v3}, Ljava/lang/RuntimeException;-><init>(Ljava/lang/String;Ljava/lang/Throwable;)V
...
.method public static main([Ljava/lang/String;)V
    ...
    const-string/jumbo v6, "smartshow context0"
    ...
    const-string/jumbo v6, "smartshow attach0"
    ...
    const-string/jumbo v6, "smartshow context1"
    ...
    const-string/jumbo v6, "smartshow attach1"
