...
.method public onTransact(ILandroid/os/Parcel;Landroid/os/Parcel;I)Z
    ...
    .line 214
    .local v225, "result":Landroid/app/IActivityManager$WaitResult;
    invoke-virtual/range {p3 .. p3}, Landroid/os/Parcel;->writeNoException()V
    ...
    .end local v16    # "options":Landroid/os/Bundle;
    .end local v17    # "userId":I
    .end local v225    # "result":Landroid/app/IActivityManager$WaitResult;
    :cond_6
    const/4 v15, 0x0
    ...
    .line 522
    .local v196, "map":Landroid/os/Bundle;
    invoke-virtual/range {p2 .. p2}, Landroid/os/Parcel;->readPersistableBundle()Landroid/os/PersistableBundle;

    move-result-object v210

    .line 523
    .local v210, "persistentState":Landroid/os/PersistableBundle;
    ...
    .end local v196    # "map":Landroid/os/Bundle;
    .end local v210    # "persistentState":Landroid/os/PersistableBundle;
    :pswitch_1b
    const-string v6, "android.app.IActivityManager"
    ...
    check-cast v220, Landroid/graphics/Rect;

    .line 733
    .local v220, "r":Landroid/graphics/Rect;
    move-object/from16 v0, p0
    ...
    .line 739
    .end local v220    # "r":Landroid/graphics/Rect;
    .end local v235    # "stackId":I
    ...
    .line 836
    .local v218, "providers":Ljava/util/ArrayList;, "Ljava/util/ArrayList<Landroid/app/IActivityManager$ContentProviderHolder;>;"
    move-object/from16 v0, p0
    ...
    .end local v7    # "app":Landroid/app/IApplicationThread;
    .end local v149    # "b":Landroid/os/IBinder;
    .end local v218    # "providers":Ljava/util/ArrayList;, "Ljava/util/ArrayList<Landroid/app/IActivityManager$ContentProviderHolder;>;"
    :pswitch_38
    const-string v6, "android.app.IActivityManager"
    ...
    .line 890
    .local v212, "pi":Landroid/app/PendingIntent;
    invoke-virtual/range {p3 .. p3}, Landroid/os/Parcel;->writeNoException()V
    ...
    .end local v212    # "pi":Landroid/app/PendingIntent;
    :pswitch_3e
    const-string v6, "android.app.IActivityManager"
    ...
    .line 1031
    .local v228, "results":Landroid/os/Bundle;
    move-object/from16 v0, p0
    ...
    .end local v51    # "resultCode":I
    .end local v149    # "b":Landroid/os/IBinder;
    .end local v228    # "results":Landroid/os/Bundle;
    :pswitch_49
    const-string v6, "android.app.IActivityManager"
    ...
    .line 1056
    .local v224, "requestedOrientation":I
    move-object/from16 v0, p0
    ...
    .line 1062
    .end local v60    # "token":Landroid/os/IBinder;
    .end local v224    # "requestedOrientation":I
    :pswitch_4c
    const-string v6, "android.app.IActivityManager"
    ...
    .line 1119
    .local v220, "r":Landroid/content/IIntentSender;
    move-object/from16 v0, p0
    ...
    .line 1125
    .end local v220    # "r":Landroid/content/IIntentSender;
    :pswitch_51
    const-string v6, "android.app.IActivityManager"
    ...
    .line 1128
    .restart local v220    # "r":Landroid/content/IIntentSender;
    move-object/from16 v0, p0
    ...
    .line 1228
    .local v204, "observer":Landroid/content/pm/IPackageDataObserver;
    invoke-virtual/range {p2 .. p2}, Landroid/os/Parcel;->readInt()I
    ...
    .end local v17    # "userId":I
    .end local v20    # "packageName":Ljava/lang/String;
    .end local v204    # "observer":Landroid/content/pm/IPackageDataObserver;
    .end local v226    # "res":Z
    :pswitch_5b
    const-string v6, "android.app.IActivityManager"
    ...
    .line 1286
    .local v209, "perms":Landroid/content/pm/ParceledListSlice;, "Landroid/content/pm/ParceledListSlice<Landroid/content/UriPermission;>;"
    invoke-virtual/range {p3 .. p3}, Landroid/os/Parcel;->writeNoException()V
    ...
    .end local v209    # "perms":Landroid/content/pm/ParceledListSlice;, "Landroid/content/pm/ParceledListSlice<Landroid/content/UriPermission;>;"
    :cond_47
    const/16 v177, 0x0
    ...
    .line 1303
    new-instance v200, Landroid/app/ActivityManager$MemoryInfo;

    invoke-direct/range {v200 .. v200}, Landroid/app/ActivityManager$MemoryInfo;-><init>()V

    .line 1304
    .local v200, "mi":Landroid/app/ActivityManager$MemoryInfo;
    move-object/from16 v0, p0
    ...
    .line 1311
    .end local v200    # "mi":Landroid/app/ActivityManager$MemoryInfo;
    :pswitch_62
    const-string v6, "android.app.IActivityManager"
    ...
    .line 1321
    .local v211, "pfd":Landroid/os/ParcelFileDescriptor;
    invoke-virtual/range {p3 .. p3}, Landroid/os/Parcel;->writeNoException()V
    ...
    .line 1332
    .end local v97    # "uri":Landroid/net/Uri;
    .end local v211    # "pfd":Landroid/os/ParcelFileDescriptor;
    :pswitch_64
    const-string v6, "android.app.IActivityManager"
    ...
    .line 1341
    .local v215, "pn":Ljava/lang/String;
    invoke-virtual/range {p2 .. p2}, Landroid/os/Parcel;->readInt()I
    ...
    .line 1349
    .end local v215    # "pn":Ljava/lang/String;
    .end local v256    # "wfd":Z
    :pswitch_66
    const-string v6, "android.app.IActivityManager"
    ...
    .line 1387
    .local v221, "reason":Ljava/lang/String;
    invoke-virtual/range {p2 .. p2}, Landroid/os/Parcel;->readInt()I
    ...
    .line 1395
    .end local v213    # "pids":[I
    .end local v221    # "reason":Ljava/lang/String;
    .end local v226    # "res":Z
    .end local v229    # "secure":Z
    :pswitch_6b
    const-string v6, "android.app.IActivityManager"
    ...
    .line 1397
    .restart local v221    # "reason":Ljava/lang/String;
    move-object/from16 v0, p0
    ...
    .line 1569
    .local v214, "pkg":Ljava/lang/String;
    invoke-virtual/range {p2 .. p2}, Landroid/os/Parcel;->readInt()I
    ...
    .end local v214    # "pkg":Ljava/lang/String;
    .end local v221    # "reason":Ljava/lang/String;
    :pswitch_7f
    const-string v6, "android.app.IActivityManager"
    ...
    .line 1596
    .local v217, "processName":Ljava/lang/String;
    invoke-virtual/range {p2 .. p2}, Landroid/os/Parcel;->readInt()I
    ...
    .line 1603
    .end local v99    # "uid":I
    .end local v217    # "processName":Ljava/lang/String;
    :pswitch_82
    const-string v6, "android.app.IActivityManager"
    ...
    .line 1711
    .local v199, "message":Ljava/lang/String;
    move-object/from16 v0, p0
    ...
    .end local v199    # "message":Ljava/lang/String;
    :pswitch_8e
    const-string v6, "android.app.IActivityManager"
    ...
    .line 1833
    .restart local v214    # "pkg":Ljava/lang/String;
    move-object/from16 v0, p0
    ...
    .line 1892
    .restart local v206    # "orStopping":Z
    .restart local v225    # "result":Z
    :cond_6b
    const/4 v6, 0x0
    ...
    .line 1918
    .local v204, "observer":Landroid/app/IProcessObserver;
    move-object/from16 v0, p0
    ...
    .line 1923
    .end local v204    # "observer":Landroid/app/IProcessObserver;
    :pswitch_a1
    const-string v6, "android.app.IActivityManager"
    ...
    .line 1926
    .restart local v204    # "observer":Landroid/app/IProcessObserver;
    move-object/from16 v0, p0
    ...
    .line 1990
    .local v216, "prefix":Ljava/lang/String;
    move-object/from16 v0, p0
    ...
    .line 1997
    .end local v216    # "prefix":Ljava/lang/String;
    .end local v220    # "r":Landroid/content/IIntentSender;
    .end local v240    # "tag":Ljava/lang/String;
    :pswitch_a8
    const-string v6, "android.app.IActivityManager"
    ...
    check-cast v202, Ljava/lang/CharSequence;

    .line 2016
    .local v202, "msg":Ljava/lang/CharSequence;
    invoke-virtual/range {p2 .. p2}, Landroid/os/Parcel;->readInt()I
    ...
    .line 2023
    .end local v202    # "msg":Ljava/lang/CharSequence;
    :pswitch_ab
    const-string v6, "android.app.IActivityManager"
    ...
    .line 2076
    .local v204, "observer":Landroid/app/IUserSwitchObserver;
    move-object/from16 v0, p0
    ...
    .line 2082
    .end local v204    # "observer":Landroid/app/IUserSwitchObserver;
    :pswitch_b1
    const-string v6, "android.app.IActivityManager"
    ...
    .line 2085
    .restart local v204    # "observer":Landroid/app/IUserSwitchObserver;
    move-object/from16 v0, p0
    ...
    .line 2130
    .restart local v223    # "requestType":I
    invoke-virtual/range {p2 .. p2}, Landroid/os/Parcel;->readString()Ljava/lang/String;
    ...
    .line 2189
    .local v207, "parentActivityToken":Landroid/os/IBinder;
    invoke-virtual/range {p2 .. p2}, Landroid/os/Parcel;->readStrongBinder()Landroid/os/IBinder;
    ...
    .end local v207    # "parentActivityToken":Landroid/os/IBinder;
    :pswitch_be
    const-string v6, "android.app.IActivityManager"
    ...
    invoke-virtual {v0, v1}, Landroid/app/ActivityManagerNative;->getInstanceId(I)I

    move-result v180

    .line 2374
    .local v180, "instanceId":I
    invoke-virtual/range {p3 .. p3}, Landroid/os/Parcel;->writeNoException()V
    ...
    .line 2384
    .restart local v180    # "instanceId":I
    move-object/from16 v0, p0
    ...
    invoke-virtual {v0, v1, v2, v3}, Landroid/app/ActivityManagerNative;->forceStopPackage(Ljava/lang/String;II)V
    ...
    invoke-virtual {v0, v1, v2, v3, v4}, Landroid/app/ActivityManagerNative;->clearApplicationUserData(Ljava/lang/String;Landroid/content/pm/IPackageDataObserver;II)Z
