...
.method private equalsForNubia(Ljava/lang/Object;)Z
    .locals 4
    .param p1, "ojectServiceState"    # Ljava/lang/Object;

    .prologue
    const/4 v1, 0x0

    .line 1192
    instance-of v2, p1, Landroid/telephony/ServiceState;

    if-eqz v2, :cond_1

    check-cast p1, Landroid/telephony/ServiceState;

    .end local p1    # "ojectServiceState":Ljava/lang/Object;
    move-object v0, p1
    ...
    .restart local p1    # "ojectServiceState":Ljava/lang/Object;
    :cond_1
    const/4 v0, 0x0
    ...
    .line 1196
    .end local p1    # "ojectServiceState":Ljava/lang/Object;
    .restart local v0    # "serviceState":Landroid/telephony/ServiceState;
    :cond_2
    iget v2, p0, Landroid/telephony/ServiceState;->mVoiceRegState:I

    iget v3, v0, Landroid/telephony/ServiceState;->mVoiceRegState:I

    if-ne v2, v3, :cond_0

    iget v2, p0, Landroid/telephony/ServiceState;->mDataRegState:I

    iget v3, v0, Landroid/telephony/ServiceState;->mDataRegState:I

    if-ne v2, v3, :cond_0

    iget v2, p0, Landroid/telephony/ServiceState;->mVoiceRoamingType:I

    iget v3, v0, Landroid/telephony/ServiceState;->mVoiceRoamingType:I

    if-ne v2, v3, :cond_0

    iget v2, p0, Landroid/telephony/ServiceState;->mDataRoamingType:I

    iget v3, v0, Landroid/telephony/ServiceState;->mDataRoamingType:I

    if-ne v2, v3, :cond_0

    iget-boolean v2, p0, Landroid/telephony/ServiceState;->mIsManualNetworkSelection:Z

    iget-boolean v3, v0, Landroid/telephony/ServiceState;->mIsManualNetworkSelection:Z

    if-ne v2, v3, :cond_0

    iget-object v2, p0, Landroid/telephony/ServiceState;->mVoiceOperatorAlphaLong:Ljava/lang/String;

    iget-object v3, v0, Landroid/telephony/ServiceState;->mVoiceOperatorAlphaLong:Ljava/lang/String;
    ...
    iget-object v3, v0, Landroid/telephony/ServiceState;->mVoiceOperatorAlphaShort:Ljava/lang/String;
    ...
    iget-object v3, v0, Landroid/telephony/ServiceState;->mVoiceOperatorNumeric:Ljava/lang/String;
    ...
    iget-object v3, v0, Landroid/telephony/ServiceState;->mDataOperatorAlphaLong:Ljava/lang/String;
    ...
    iget-object v3, v0, Landroid/telephony/ServiceState;->mDataOperatorAlphaShort:Ljava/lang/String;
    ...
    iget-object v3, v0, Landroid/telephony/ServiceState;->mDataOperatorNumeric:Ljava/lang/String;
    ...
    iget v3, v0, Landroid/telephony/ServiceState;->mRilVoiceRadioTechnology:I
    ...
    iget v3, v0, Landroid/telephony/ServiceState;->mRilDataRadioTechnology:I
    ...
    iget-boolean v3, v0, Landroid/telephony/ServiceState;->mCssIndicator:Z
    ...
    iget v3, v0, Landroid/telephony/ServiceState;->mNetworkId:I
    ...
    iget v3, v0, Landroid/telephony/ServiceState;->mSystemId:I
    ...
    iget v3, v0, Landroid/telephony/ServiceState;->mCdmaRoamingIndicator:I
    ...
    iget v3, v0, Landroid/telephony/ServiceState;->mCdmaDefaultRoamingIndicator:I
    ...
    iget-boolean v3, v0, Landroid/telephony/ServiceState;->mIsEmergencyOnly:Z

    if-ne v2, v3, :cond_0

    iget v2, p0, Landroid/telephony/ServiceState;->mBaseStationId:I

    iget v3, v0, Landroid/telephony/ServiceState;->mBaseStationId:I
...
.method private setNullState(I)V
    ...
    .line 774
    iput v4, p0, Landroid/telephony/ServiceState;->mVoiceRoamingType:I

    .line 775
    iput v4, p0, Landroid/telephony/ServiceState;->mDataRoamingType:I
    ...
    .line 794
    iput v3, p0, Landroid/telephony/ServiceState;->mBaseStationId:I

    .line 796
    return-void
.end method

.method private toStringForNubia()Ljava/lang/String;
    .locals 4
    ...
    const-string v3, " mBaseStationId"

    invoke-virtual {v2, v3}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v2

    iget v3, p0, Landroid/telephony/ServiceState;->mBaseStationId:I
...
.method public equals(Ljava/lang/Object;)Z
    ...
    .prologue
    .line 659
    invoke-direct {p0, p1}, Landroid/telephony/ServiceState;->equalsForNubia(Ljava/lang/Object;)Z
...
.method public toString()Ljava/lang/String;
    ...
    .prologue
    .line 766
    invoke-direct {p0}, Landroid/telephony/ServiceState;->toStringForNubia()Ljava/lang/String;
