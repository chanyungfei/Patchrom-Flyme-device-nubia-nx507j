.class Lnubia/os/NubiaHWTracker$GpuSpeedTime;
...
.annotation system Ldalvik/annotation/EnclosingClass;
    value = Lnubia/os/NubiaHWTracker;
.end annotation
...
.field final synthetic this$0:Lnubia/os/NubiaHWTracker;


# direct methods
.method private constructor <init>(Lnubia/os/NubiaHWTracker;)V
    .locals 2
    ...
    .line 47
    iput-object p1, p0, Lnubia/os/NubiaHWTracker$GpuSpeedTime;->this$0:Lnubia/os/NubiaHWTracker;

    invoke-direct {p0}, Ljava/lang/Object;-><init>()V

    .line 48
    iput-boolean v1, p0, Lnubia/os/NubiaHWTracker$GpuSpeedTime;->LOGV:Z

    .line 49
    const/16 v0, 0xa

    iput v0, p0, Lnubia/os/NubiaHWTracker$GpuSpeedTime;->MAX_GPUSPEEDS:I

    .line 52
    iput-boolean v1, p0, Lnubia/os/NubiaHWTracker$GpuSpeedTime;->mInitSucess:Z

    return-void
.end method

.method synthetic constructor <init>(Lnubia/os/NubiaHWTracker;Lnubia/os/NubiaHWTracker$1;)V
    .locals 0
    .param p1, "x0"    # Lnubia/os/NubiaHWTracker;
    .param p2, "x1"    # Lnubia/os/NubiaHWTracker$1;

    .prologue
    .line 47
    invoke-direct {p0, p1}, Lnubia/os/NubiaHWTracker$GpuSpeedTime;-><init>(Lnubia/os/NubiaHWTracker;)V
...
.method private busyDeltaTime(D)V
    ...
    .local v0, "i":I
    :goto_0
    iget-object v1, p0, Lnubia/os/NubiaHWTracker$GpuSpeedTime;->mDeltaGpuSpeedsTimes:[J
...
.method private getCurGpuSpeedTimes()Z
    ...
    iget-object v9, p0, Lnubia/os/NubiaHWTracker$GpuSpeedTime;->mDeltaGpuSpeedsTimes:[J
    ...
    .line 161
    .local v7, "speed":I
    iget-boolean v12, p0, Lnubia/os/NubiaHWTracker$GpuSpeedTime;->mInitSucess:Z
    ...
    .line 207
    iput-boolean v11, p0, Lnubia/os/NubiaHWTracker$GpuSpeedTime;->mInitSucess:Z
    ...
    iput-object v12, p0, Lnubia/os/NubiaHWTracker$GpuSpeedTime;->mDeltaGpuSpeedsTimes:[J

    .line 209
    iget-object v12, p0, Lnubia/os/NubiaHWTracker$GpuSpeedTime;->mDeltaGpuSpeedsTimes:[J
...
.method public getGpuBusyRate()D
    ...
    iget-boolean v0, v0, Lnubia/os/NubiaHWTracker$GpuSpeedTime;->LOGV:Z
...
.method public getLastGpuSpeedTimes()[J
    ...
    .line 68
    invoke-direct {p0}, Lnubia/os/NubiaHWTracker$GpuSpeedTime;->initDeltaTime()V

    .line 70
    invoke-direct {p0}, Lnubia/os/NubiaHWTracker$GpuSpeedTime;->getCurGpuSpeedTimes()Z
    ...
    .line 71
    iget-object v3, p0, Lnubia/os/NubiaHWTracker$GpuSpeedTime;->mDeltaGpuSpeedsTimes:[J
    ...
    .line 74
    :cond_0
    iget-object v3, p0, Lnubia/os/NubiaHWTracker$GpuSpeedTime;->mCurGpuSpeedTimes:[J
    ...
    iput-object v3, p0, Lnubia/os/NubiaHWTracker$GpuSpeedTime;->mCurGpuSpeedTimes:[J

    .line 76
    iget-object v3, p0, Lnubia/os/NubiaHWTracker$GpuSpeedTime;->mDeltaGpuSpeedsTimes:[J

    iget-object v6, p0, Lnubia/os/NubiaHWTracker$GpuSpeedTime;->mCurGpuSpeedTimes:[J

    iget-object v7, p0, Lnubia/os/NubiaHWTracker$GpuSpeedTime;->mDeltaGpuSpeedsTimes:[J
    ...
    .line 90
    :cond_1
    invoke-virtual {p0}, Lnubia/os/NubiaHWTracker$GpuSpeedTime;->getGpuBusyRate()D

    move-result-wide v0

    .line 91
    .local v0, "busyrate":D
    invoke-direct {p0, v0, v1}, Lnubia/os/NubiaHWTracker$GpuSpeedTime;->busyDeltaTime(D)V

    .line 93
    iget-boolean v3, p0, Lnubia/os/NubiaHWTracker$GpuSpeedTime;->LOGV:Z
    ...
    iget-object v7, p0, Lnubia/os/NubiaHWTracker$GpuSpeedTime;->mCurGpuSpeedTimes:[J
    ...
    iget-object v8, p0, Lnubia/os/NubiaHWTracker$GpuSpeedTime;->mCurGpuSpeedTimes:[J
