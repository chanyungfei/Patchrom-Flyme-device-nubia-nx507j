.class public Lnubia/media/NubiaVolume;
...
.method public constructor <init>(Landroid/content/Context;Landroid/media/AudioService;)V
    ...
    .param p2, "audioService"    # Landroid/media/AudioService;
    ...
    iput v0, p0, Lnubia/media/NubiaVolume;->mAffectStreamTypeByRingerModeForNubia:I

    .line 33
    iput-object p2, p0, Lnubia/media/NubiaVolume;->mAudioService:Landroid/media/AudioService;

    .line 34
    iput-object p1, p0, Lnubia/media/NubiaVolume;->mContext:Landroid/content/Context;
...
.method public getLastRingerMode()I
    ...
    .prologue
    .line 159
    iget v0, p0, Lnubia/media/NubiaVolume;->mLastRingerMode:I
...
.method public getLastStreamVolume()I
    ...
    .line 182
    .local v0, "ident":J
    iget-object v3, p0, Lnubia/media/NubiaVolume;->mContext:Landroid/content/Context;
...
.method public initStateForSilentMode()V
    ...
    .line 39
    iget-object v6, p0, Lnubia/media/NubiaVolume;->mContext:Landroid/content/Context;
    ...
    :goto_0
    iput-boolean v6, p0, Lnubia/media/NubiaVolume;->mSetRingerMode:Z

    .line 47
    iput v1, p0, Lnubia/media/NubiaVolume;->mLastPersistMusicVolume:I

    .line 48
    iput v2, p0, Lnubia/media/NubiaVolume;->mLastRingerMode:I
    ...
    iput v6, p0, Lnubia/media/NubiaVolume;->mOriginVolume:I
    ...
    :goto_1
    iput-boolean v7, p0, Lnubia/media/NubiaVolume;->mVolumeRestored:Z

    .line 53
    iget-boolean v6, p0, Lnubia/media/NubiaVolume;->mVolumeRestored:Z
    ...
    :goto_2
    iget v6, p0, Lnubia/media/NubiaVolume;->mOriginVolume:I
...
.method public modifyAffectedStreamVolume(IIIIIII)I
    ...
    iget-object v1, p0, Lnubia/media/NubiaVolume;->mAudioService:Landroid/media/AudioService;
    ...
    iget v1, p0, Lnubia/media/NubiaVolume;->mLastPersistMusicVolume:I
    ...
    iget v2, p0, Lnubia/media/NubiaVolume;->mLastPersistMusicVolume:I
...
.method public modifyHeadSetVolume(II)V
    ...
    .line 193
    iget-object v2, p0, Lnubia/media/NubiaVolume;->mAudioService:Landroid/media/AudioService;

    invoke-virtual {v2, v4, v4}, Landroid/media/AudioService;->getStreamVolumeForDevice(II)I

    move-result v2

    iput v2, p0, Lnubia/media/NubiaVolume;->mOriginVolume:I

    .line 195
    iget v2, p0, Lnubia/media/NubiaVolume;->mOriginVolume:I
    ...
    invoke-virtual {v2, v4, v6, v1, v3}, Landroid/media/AudioService;->setStreamVolume(IIILjava/lang/String;)V

    .line 198
    iput-boolean v0, p0, Lnubia/media/NubiaVolume;->mVolumeRestored:Z

    .line 202
    :goto_1
    iget-object v2, p0, Lnubia/media/NubiaVolume;->mContext:Landroid/content/Context;

    invoke-virtual {v2}, Landroid/content/Context;->getContentResolver()Landroid/content/ContentResolver;

    move-result-object v2

    const-string v3, "headset_plug_origin_volume"

    iget v4, p0, Lnubia/media/NubiaVolume;->mOriginVolume:I
    ...
    const-string v3, "headset_volume_restored"

    iget-boolean v4, p0, Lnubia/media/NubiaVolume;->mVolumeRestored:Z
    ...
    .line 200
    :cond_2
    iput-boolean v1, p0, Lnubia/media/NubiaVolume;->mVolumeRestored:Z

    goto :goto_1

    .line 206
    :cond_3
    iget-boolean v2, p0, Lnubia/media/NubiaVolume;->mVolumeRestored:Z
    ...
    iget v3, p0, Lnubia/media/NubiaVolume;->mOriginVolume:I

    invoke-virtual {v2, v4, v4, v3, v1}, Landroid/media/AudioService;->setStreamVolumeForDevice(IIII)V
...
.method public modifyIndexForDevice(III)V
    ...
    iput v0, p0, Lnubia/media/NubiaVolume;->mLastPersistMusicVolume:I
...
.method public persistAffectedVolume(II)V
    ...
    .line 109
    iget-object v0, p0, Lnubia/media/NubiaVolume;->mContext:Landroid/content/Context;
    ...
    iget-boolean v0, p0, Lnubia/media/NubiaVolume;->mVolumeRestored:Z
...
.method public persistWhenRingerModeChange(I)V
    ...
    .line 95
    iget-object v1, p0, Lnubia/media/NubiaVolume;->mContext:Landroid/content/Context;
    ...
    iget v2, p0, Lnubia/media/NubiaVolume;->mLastRingerMode:I
    ...
    iget-boolean v1, p0, Lnubia/media/NubiaVolume;->mSetRingerMode:Z
...
.method public saveStreamVolume(IZ)V
    ...
    .line 177
    :cond_1
    iget-object v0, p0, Lnubia/media/NubiaVolume;->mAudioService:Landroid/media/AudioService;

    invoke-virtual {v0, p1}, Landroid/media/AudioService;->getStreamVolume(I)I

    move-result v0

    invoke-virtual {p0, v0}, Lnubia/media/NubiaVolume;->saveRingerStreamVolume(I)V
...
.method public updateStateWhenRingerModeChange(I)V
    ...
    iput v0, p0, Lnubia/media/NubiaVolume;->mLastRingerMode:I

    .line 90
    iget-boolean v0, p0, Lnubia/media/NubiaVolume;->mAdjustVolume:Z
    ...
    :goto_0
    iput-boolean v0, p0, Lnubia/media/NubiaVolume;->mSetRingerMode:Z
...
.method public updateStreamVolume(ZII)V
    ...
    invoke-virtual {v1, p2, v4}, Landroid/media/AudioService;->getCurrentIndexForDevice(II)I

    move-result v0

    .line 68
    .local v0, "currentIndex":I
    const-string v1, "NubiaVolume"
    ...
    iget v3, p0, Lnubia/media/NubiaVolume;->mLastPersistMusicVolume:I
    ...
    invoke-virtual {v1, p2, v4, v2, v5}, Landroid/media/AudioService;->setStreamVolumeForDevice(IIII)V
    ...
    invoke-virtual {v1, p2, v4, v5, v5}, Landroid/media/AudioService;->setStreamVolumeForDevice(IIII)V
