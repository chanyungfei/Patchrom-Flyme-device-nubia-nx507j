...
.method runOnce()Z
    ...
    .line 152
    .local v38, "parsedArgs":Lcom/android/internal/os/ZygoteConnection$Arguments;
    invoke-static {}, Landroid/os/SystemClock;->elapsedRealtime()J
    ...
    .line 173
    .local v37, "newStderr":Ljava/io/PrintStream;
    if-eqz v34, :cond_1
    ...
    .line 174
    new-instance v37, Ljava/io/PrintStream;

    .end local v37    # "newStderr":Ljava/io/PrintStream;
    ...
    .line 178
    .restart local v37    # "newStderr":Ljava/io/PrintStream;
    :cond_1
    const/16 v40, -0x1
    ...
    .line 183
    .local v42, "serverPipeFd":Ljava/io/FileDescriptor;
    :try_start_1
    new-instance v39, Lcom/android/internal/os/ZygoteConnection$Arguments;
    ...
    .line 185
    .end local v38    # "parsedArgs":Lcom/android/internal/os/ZygoteConnection$Arguments;
    ...
    .restart local v38    # "parsedArgs":Lcom/android/internal/os/ZygoteConnection$Arguments;
    goto :goto_0
    ...
    .line 278
    .end local v39    # "parsedArgs":Lcom/android/internal/os/ZygoteConnection$Arguments;
    .restart local v35    # "ex":Ljava/io/IOException;
    .restart local v38    # "parsedArgs":Lcom/android/internal/os/ZygoteConnection$Arguments;
    :goto_1
    ...
    .line 291
    :try_start_3
    invoke-static/range {v42 .. v42}, Llibcore/io/IoUtils;->closeQuietly(Ljava/io/FileDescriptor;)V
    ...
    .line 203
    invoke-static/range {v39 .. v39}, Lcom/android/internal/os/ZygoteConnection;->applyDebuggerSystemProperty(Lcom/android/internal/os/ZygoteConnection$Arguments;)V

    .line 204
    invoke-static/range {v39 .. v39}, Lcom/android/internal/os/ZygoteConnection;->applyInvokeWithSystemProperty(Lcom/android/internal/os/ZygoteConnection$Arguments;)V
    ...
    .line 216
    .local v41, "pipeFds":[Ljava/io/FileDescriptor;
    const/4 v6, 0x1

    aget-object v33, v41, v6

    .line 217
    const/4 v6, 0x0

    aget-object v42, v41, v6
    ...
    .line 233
    .end local v41    # "pipeFds":[Ljava/io/FileDescriptor;
    :cond_6
    const/4 v6, 0x2
