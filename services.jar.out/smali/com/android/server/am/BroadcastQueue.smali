...
.method private appSrcDirNotFile(Landroid/content/pm/ResolveInfo;)Z
    .locals 8
    ...
    .line 1047
    .local v2, "srcDir":Ljava/lang/String;
    if-eqz v2, :cond_1
    ...
    const-string v7, "[error] apk not exist, skip cur broadcast: "
    ...
    .line 1054
    .end local v2    # "srcDir":Ljava/lang/String;
    :cond_0
    :goto_1
    if-nez v1, :cond_2
    ...
    .restart local v2    # "srcDir":Ljava/lang/String;
    :cond_1
    move v1, v4
...
.method final processNextBroadcast(Z)V
    ...
    .line 561
    .local v32, "nubiaSelfStartUtil":Lcom/android/server/am/NubiaSelfStartUtil;
    invoke-virtual/range {v32 .. v32}, Lcom/android/server/am/NubiaSelfStartUtil;->firstBootGetAllowPkgNames()V
    ...
    iget-object v6, v4, Lcom/android/server/am/ActivityManagerService;->mAmSmartShowFuncs:Lcom/android/server/am/IAmSmartShowFuncs;

    move-object/from16 v0, v36

    iget-object v4, v0, Lcom/android/server/am/BroadcastRecord;->callerApp:Lcom/android/server/am/ProcessRecord;

    iget v7, v4, Lcom/android/server/am/ProcessRecord;->dataId:I
    ...
    invoke-interface {v6, v7, v4, v0}, Lcom/android/server/am/IAmSmartShowFuncs;->checkBroadcastAndRegisteredReceiverLocked(ILcom/android/server/am/BroadcastFilter;Ljava/lang/Object;)Z
    ...
    .line 599
    .restart local v40    # "target":Ljava/lang/Object;
    :cond_2
    check-cast v40, Lcom/android/server/am/BroadcastFilter;
    ...
    iget v6, v6, Lcom/android/server/am/ProcessRecord;->dataId:I

    move-object/from16 v0, v19

    move-object/from16 v1, v36

    invoke-interface {v4, v6, v0, v1}, Lcom/android/server/am/IAmSmartShowFuncs;->checkBroadcastAndRegisteredReceiverLocked(ILcom/android/server/am/BroadcastFilter;Ljava/lang/Object;)Z
    ...
    .restart local v19    # "filter":Lcom/android/server/am/BroadcastFilter;
    ...
    .line 822
    sget-boolean v4, Lcn/nubia/server/ApplicationManagerConfig;->DEBUG:Z
    ...
    iget v4, v0, Landroid/content/pm/ResolveInfo;->instance:I
    ...
    invoke-interface {v6, v5, v7, v4, v0}, Lcom/android/server/am/IAmSmartShowFuncs;->getFixedProcessRecordLocked(Ljava/lang/String;Landroid/content/pm/ApplicationInfo;ILjava/lang/Object;)Lcom/android/server/am/ProcessRecord;
    ...
    iget v4, v4, Lcom/android/server/am/ProcessRecord;->dataId:I
    ...
    invoke-direct {v0, v1}, Lcom/android/server/am/BroadcastQueue;->appSrcDirNotFile(Landroid/content/pm/ResolveInfo;)Z
    ...
    .line 1004
    .local v25, "isForbiddenSelfStart":Z
    :goto_10
    if-nez v25, :cond_2b
    ...
    iget v14, v0, Landroid/content/pm/ResolveInfo;->instance:I
    ...
    :goto_12
    invoke-interface/range {v4 .. v14}, Lcom/android/server/am/IAmSmartShowFuncs;->startProcessLocked(Ljava/lang/String;Landroid/content/pm/ApplicationInfo;ZILjava/lang/String;Landroid/content/ComponentName;ZZZI)Lcom/android/server/am/ProcessRecord;
    ...
    .line 969
    .end local v25    # "isForbiddenSelfStart":Z
    :catch_6
    move-exception v18
    ...
    .line 1007
    .restart local v25    # "isForbiddenSelfStart":Z
    :cond_2e
    const/4 v11, 0x0
    ...
    iget v14, v14, Lcom/android/server/am/ProcessRecord;->dataId:I
