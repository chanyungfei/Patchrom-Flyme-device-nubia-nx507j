...
.method public constructor <init>(Lcom/android/server/am/ActivityManagerService;)V
    ...
    iput v1, p0, Lcom/android/server/am/ActiveServices;->mExtId:I
    ...
    iput-object v1, p0, Lcom/android/server/am/ActiveServices;->mNubiaSelfStartUtil:Lcom/android/server/am/NubiaSelfStartUtil;
...
.method private final bringUpServiceLocked(Lcom/android/server/am/ServiceRecord;IZZ)Ljava/lang/String;
    ...
    iget v4, v0, Lcom/android/server/am/ActiveServices;->mExtId:I
    ...
    iget v7, v0, Lcom/android/server/am/ActiveServices;->mExtId:I
    ...
    iput v4, v15, Lcom/android/server/am/ProcessRecord;->dataId:I
    ...
    iget v14, v0, Lcom/android/server/am/ActiveServices;->mExtId:I
...
.method bindServiceLocked(Landroid/app/IApplicationThread;Landroid/os/IBinder;Landroid/content/Intent;Ljava/lang/String;Landroid/app/IServiceConnection;II)I
    ...
    .line 801
    .local v25, "fromJobScheduler":Z
    const/16 v26, 0x0

    .line 802
    .local v26, "fromSyncManager":Z
    const/16 v33, 0x0

    .line 804
    .local v33, "syncReason":I
    :try_start_0
    ...
    .line 807
    .local v31, "serviceAction":Ljava/lang/String;
    if-eqz v31, :cond_4
    ...
    .line 809
    :goto_1
    const-string v6, "NUBIA_SYNCMANAGER_REASON"
    ...
    .line 815
    .end local v31    # "serviceAction":Ljava/lang/String;
    :goto_2
    move-object/from16 v0, v20
    ...
    .restart local v31    # "serviceAction":Ljava/lang/String;
    :cond_4
    const/16 v26, 0x0
    ...
    invoke-static {v6, v7}, Lnubia/os/ApplicationManager$Trigger;->allow3rdPartyPush(Ljava/lang/String;Ljava/lang/String;)Z
    ...
    .line 856
    sget-boolean v6, Lcn/nubia/server/ApplicationManagerConfig;->DEBUG:Z
    ...
    const-string v8, "prevent a push service start , pkg = "
    ...
    const-string v8, "bindService caller Pid = "
    ...
    const-string v8, " callerApp.pkgList ="
    ...
    iget-object v8, v0, Lcom/android/server/am/ProcessRecord;->pkgList:Landroid/util/ArrayMap;
    ...
    iget-object v6, v0, Lcom/android/server/am/ProcessRecord;->pkgList:Landroid/util/ArrayMap;
    ...
    iget-object v6, v0, Lcom/android/server/am/ActiveServices;->mNubiaSelfStartUtil:Lcom/android/server/am/NubiaSelfStartUtil;
    ...
    invoke-virtual {v6, v0, v7}, Lcom/android/server/am/NubiaSelfStartUtil;->isAllowedSelfStartFromBindService(Lcom/android/server/am/ServiceRecord;I)Z
    ...
    const-string v8, "forbid starting "
    ...
    const-string v7, "from job scheduler"
    ...
    invoke-virtual {v6, v7, v8}, Lcom/android/server/am/NubiaSelfStartUtil;->isAllowedSelfStartPkg(Landroid/content/pm/ApplicationInfo;I)Z
    ...
    const-string v8, "fromJobScheduler forbid starting "
    ...
    const-string v8, "from sync manager syncReason="
    ...
    const-string v8, "fromSyncManager forbid starting "
    ...
    .line 915
    invoke-virtual/range {v30 .. v30}, Lcom/android/server/am/ServiceRecord;->hasAutoCreateConnections()Z
    ...
    .line 917
    invoke-virtual/range {v30 .. v30}, Lcom/android/server/am/ServiceRecord;->getTracker()Lcom/android/internal/app/ProcessStats$ServiceState;
...
.method final killServicesLocked(Lcom/android/server/am/ProcessRecord;Z)V
    ...
    iget-object v0, v0, Lcom/android/server/am/ActiveServices;->mNubiaSelfStartUtil:Lcom/android/server/am/NubiaSelfStartUtil;
    ...
    invoke-virtual {v0, v1}, Lcom/android/server/am/NubiaSelfStartUtil;->isAllowedServiceRestart(Lcom/android/server/am/ProcessRecord;)Z
...
.method startServiceLocked(Landroid/app/IApplicationThread;Landroid/content/Intent;Ljava/lang/String;III)Landroid/content/ComponentName;
    ...
    .line 332
    .local v17, "callerPkgList":Landroid/util/ArrayMap;, "Landroid/util/ArrayMap<Ljava/lang/String;Lcom/android/internal/app/ProcessStats$ProcessStateHolder;>;"
    if-eqz p1, :cond_2
    ...
    invoke-static {v2, v3}, Lnubia/os/ApplicationManager$Trigger;->allow3rdPartyPush(Ljava/lang/String;Ljava/lang/String;)Z
    ...
    const-string v4, "prevent a push service start , pkg = "
    ...
    const-string v4, ", target_process = "

    invoke-virtual {v3, v4}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v3

    iget-object v4, v13, Lcom/android/server/am/ServiceRecord;->processName:Ljava/lang/String;
    ...
    const-string v4, "start service caller PID ="
    ...
    iget-object v4, v13, Lcom/android/server/am/ServiceRecord;->name:Landroid/content/ComponentName;
    ...
    iget-object v2, v0, Lcom/android/server/am/ActiveServices;->mNubiaSelfStartUtil:Lcom/android/server/am/NubiaSelfStartUtil;

    iget-object v3, v13, Lcom/android/server/am/ServiceRecord;->appInfo:Landroid/content/pm/ApplicationInfo;

    move/from16 v0, p5

    invoke-virtual {v2, v3, v0}, Lcom/android/server/am/NubiaSelfStartUtil;->isAllowedSelfStartPkg(Landroid/content/pm/ApplicationInfo;I)Z
    ...
    const-string v4, "forbid starting "
    ...
    .line 398
    :try_start_0
    const-string v2, "android.intent.extra.ALARM_COUNT"
    ...
    iget v2, v0, Lcom/android/server/am/ActiveServices;->mExtId:I
    ...
    iget v5, v0, Lcom/android/server/am/ActiveServices;->mExtId:I
    ...
    .end local v15    # "addToStarting":Z
    .end local v19    # "proc":Lcom/android/server/am/ProcessRecord;
    .restart local v18    # "hasExtraAlarm":Z
    :catch_0
    move-exception v2
