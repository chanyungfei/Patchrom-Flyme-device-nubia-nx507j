...
# direct methods
.method constructor <init>(Lcom/android/server/am/ActivityManagerService;Lcom/android/server/am/ActiveServices;Lcom/android/internal/os/BatteryStatsImpl$Uid$Pkg$Serv;Landroid/content/ComponentName;Landroid/content/Intent$FilterComparison;Landroid/content/pm/ServiceInfo;ZLjava/lang/Runnable;)V
    .locals 2
    .param p1, "ams"    # Lcom/android/server/am/ActivityManagerService;
    .param p2, "as"    # Lcom/android/server/am/ActiveServices;
    .param p3, "servStats"    # Lcom/android/internal/os/BatteryStatsImpl$Uid$Pkg$Serv;
    .param p4, "name"    # Landroid/content/ComponentName;
    .param p5, "intent"    # Landroid/content/Intent$FilterComparison;
    .param p6, "sInfo"    # Landroid/content/pm/ServiceInfo;
    .param p7, "callerIsFg"    # Z
    .param p8, "restarter"    # Ljava/lang/Runnable;
    ...
    .line 317
    iput-object p2, p0, Lcom/android/server/am/ServiceRecord;->mServices:Lcom/android/server/am/ActiveServices;

    .line 319
    iput-object p3, p0, Lcom/android/server/am/ServiceRecord;->stats:Lcom/android/internal/os/BatteryStatsImpl$Uid$Pkg$Serv;

    .line 320
    iput-object p4, p0, Lcom/android/server/am/ServiceRecord;->name:Landroid/content/ComponentName;
    ...
    .line 322
    iput-object p5, p0, Lcom/android/server/am/ServiceRecord;->intent:Landroid/content/Intent$FilterComparison;

    .line 323
    iput-object p6, p0, Lcom/android/server/am/ServiceRecord;->serviceInfo:Landroid/content/pm/ServiceInfo;

    .line 324
    iget-object v0, p6, Landroid/content/pm/ServiceInfo;->applicationInfo:Landroid/content/pm/ApplicationInfo;
    ...
    .line 326
    iget-object v0, p6, Landroid/content/pm/ServiceInfo;->processName:Ljava/lang/String;

    iput-object v0, p0, Lcom/android/server/am/ServiceRecord;->processName:Ljava/lang/String;

    .line 327
    iget-object v0, p6, Landroid/content/pm/ServiceInfo;->permission:Ljava/lang/String;

    iput-object v0, p0, Lcom/android/server/am/ServiceRecord;->permission:Ljava/lang/String;

    .line 328
    iget-boolean v0, p6, Landroid/content/pm/ServiceInfo;->exported:Z

    iput-boolean v0, p0, Lcom/android/server/am/ServiceRecord;->exported:Z

    .line 329
    iput-object p8, p0, Lcom/android/server/am/ServiceRecord;->restarter:Ljava/lang/Runnable;
    ...
    .line 333
    iput-boolean p7, p0, Lcom/android/server/am/ServiceRecord;->createdFromFg:Z
...
.method public cancelNotification()V
    ...
    iget-object v3, p0, Lcom/android/server/am/ServiceRecord;->mServices:Lcom/android/server/am/ActiveServices;

    iget v0, v3, Lcom/android/server/am/ActiveServices;->mExtId:I
    ...
    new-instance v4, Lcom/android/server/am/ServiceRecord$2;

    invoke-direct {v4, p0, v0, v2, v1}, Lcom/android/server/am/ServiceRecord$2;-><init>(Lcom/android/server/am/ServiceRecord;ILjava/lang/String;I)V

    invoke-virtual {v3, v4}, Lcom/android/server/am/ActivityManagerService$MainHandler;->post(Ljava/lang/Runnable;)Z

    .line 548
    .end local v0    # "extId":I
    .end local v1    # "localForegroundId":I
