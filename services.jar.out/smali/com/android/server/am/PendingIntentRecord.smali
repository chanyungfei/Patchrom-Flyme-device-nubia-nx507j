...
# instance fields
.field caller:Lcom/android/server/am/ProcessRecord;
...
.method sendInner(ILandroid/content/Intent;Ljava/lang/String;Landroid/content/IIntentReceiver;Ljava/lang/String;Landroid/os/IBinder;Ljava/lang/String;IIILandroid/os/Bundle;Landroid/app/IActivityContainer;)I
    ...
    .line 236
    .local v15, "finalIntent":Landroid/content/Intent;
    :goto_0
    if-eqz p2, :cond_7
    ...
    invoke-virtual {v15, v0, v2}, Landroid/content/Intent;->fillIn(Landroid/content/Intent;I)I
    ...
    invoke-virtual {v15, v2, v3}, Landroid/content/Intent;->putSmartShowExtra(Ljava/lang/String;Ljava/lang/String;)Landroid/content/Intent;
    ...
    iget v10, v2, Lcom/android/server/am/PendingIntentRecord$Key;->userId:I
    ...
    invoke-interface/range {v16 .. v23}, Landroid/content/IIntentReceiver;->performReceive(Landroid/content/Intent;ILjava/lang/String;Landroid/os/Bundle;ZZI)V
    :try_end_1
    ...
    .end local v15    # "finalIntent":Landroid/content/Intent;
    ...
    .line 242
    .restart local v15    # "finalIntent":Landroid/content/Intent;
    :cond_7
    :try_start_3
    move-object/from16 v0, p0
    ...
    iget-object v3, v0, Lcom/android/server/am/PendingIntentRecord;->caller:Lcom/android/server/am/ProcessRecord;
    ...
    invoke-virtual/range {v2 .. v10}, Lcom/android/server/am/ActivityManagerService;->startActivitiesInPackage(Landroid/app/IApplicationThread;ILjava/lang/String;[Landroid/content/Intent;[Ljava/lang/String;Landroid/os/IBinder;Landroid/os/Bundle;I)I
    :try_end_4
    ...
    iget-object v2, v0, Lcom/android/server/am/PendingIntentRecord;->caller:Lcom/android/server/am/ProcessRecord;
    ...
    iget v13, v0, Lcom/android/server/am/PendingIntentRecord;->uid:I

    move-object/from16 v0, p0

    iget-object v2, v0, Lcom/android/server/am/PendingIntentRecord;->key:Lcom/android/server/am/PendingIntentRecord$Key;

    iget-object v14, v2, Lcom/android/server/am/PendingIntentRecord$Key;->packageName:Ljava/lang/String;
    ...
    invoke-virtual/range {v11 .. v24}, Lcom/android/server/am/ActivityManagerService;->startActivityInPackage(Landroid/app/IApplicationThread;ILjava/lang/String;Landroid/content/Intent;Ljava/lang/String;Landroid/os/IBinder;Ljava/lang/String;IILandroid/os/Bundle;ILandroid/app/IActivityContainer;Lcom/android/server/am/TaskRecord;)I
    :try_end_6
    ...
    iget-object v12, v0, Lcom/android/server/am/PendingIntentRecord;->caller:Lcom/android/server/am/ProcessRecord;
    ...
    invoke-virtual/range {v11 .. v24}, Lcom/android/server/am/ActivityManagerService;->broadcastIntentInPackage(Lcom/android/server/am/ProcessRecord;Ljava/lang/String;ILandroid/content/Intent;Ljava/lang/String;Landroid/content/IIntentReceiver;ILjava/lang/String;Landroid/os/Bundle;Ljava/lang/String;ZZI)I
    :try_end_8
    ...
    invoke-virtual/range {v12 .. v17}, Lcom/android/server/am/ActivityManagerService;->startServiceInPackage(Landroid/app/IApplicationThread;ILandroid/content/Intent;Ljava/lang/String;I)Landroid/content/ComponentName;
    :try_end_a
