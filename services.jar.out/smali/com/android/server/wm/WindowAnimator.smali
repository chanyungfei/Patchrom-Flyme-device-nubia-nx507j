...
.field public static mFinishDrawing:Z

.field public static mLock:Ljava/lang/Object;

.field public static mStartWakeup:Z
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lcom/android/server/wm/WindowAnimator;->mLock:Ljava/lang/Object;
...
.method static synthetic access$000(Lcom/android/server/wm/WindowAnimator;)V
    ...
    .prologue
    .line 62
    invoke-direct {p0}, Lcom/android/server/wm/WindowAnimator;->animationWaitWhenWakeup()V
...
.method private animateLocked()V
    ...
    const-string v20, "@@@animateLocked: mInitialized is false!!"
...
.method private animationWaitWhenWakeup()V
    .locals 8
    ...
    .line 948
    sget-boolean v0, Lcom/android/server/wm/WindowAnimator;->mFinishDrawing:Z

    if-eqz v0, :cond_1

    .line 949
    sput-boolean v4, Lcom/android/server/wm/WindowAnimator;->mFinishDrawing:Z

    .line 950
    sput-boolean v4, Lcom/android/server/wm/WindowAnimator;->mStartWakeup:Z
    ...
    const-string v2, "WindowAnimator_wait"
...
.method private printInCallUILog(Lcom/android/server/wm/WindowState;Ljava/lang/String;)V
    ...
    .prologue
    .line 940
    invoke-direct {p0, p1}, Lcom/android/server/wm/WindowAnimator;->isInCallUI(Lcom/android/server/wm/WindowState;)Z
...
.method private shouldForceHide(Lcom/android/server/wm/WindowState;)Z
    ...
    const-string v8, "@@@shouldForceHide: AppWindowToken = "
    ...
    invoke-direct {p0, v4, v7}, Lcom/android/server/wm/WindowAnimator;->printInCallUILog(Lcom/android/server/wm/WindowState;Ljava/lang/String;)V
...
.method private updateWindowsLocked(I)V
    ...
    const-string v27, "@@@updateWindowsLocked: shouldBeForceHidden = "
    ...
    const-string v27, ", canBeForceHidden = "
    ...
    invoke-direct {v0, v1, v2}, Lcom/android/server/wm/WindowAnimator;->printInCallUILog(Lcom/android/server/wm/WindowState;Ljava/lang/String;)V
    ...
    const-string v27, "@@@updateWindowsLocked: visibleNow = "
