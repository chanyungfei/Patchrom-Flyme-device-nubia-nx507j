...
.method private printInCallUILog(Lcom/android/server/wm/WindowState;Ljava/lang/String;)V
    ...
    .prologue
    .line 2103
    invoke-direct {p0, p1}, Lcom/android/server/wm/WindowStateAnimator;->isInCallUI(Lcom/android/server/wm/WindowState;)Z
...
.method public prepareSurfaceLocked(Z)V
    ...
    .line 1569
    :cond_0
    const-string v3, "@@@prepareSurfaceLocked: return due to mSurfaceControl is null"

    invoke-direct {p0, v2, v3}, Lcom/android/server/wm/WindowStateAnimator;->printInCallUILog(Lcom/android/server/wm/WindowState;Ljava/lang/String;)V
    ...
    const-string v4, "@@@prepareSurfaceLocked: HiddenRequestedLw!!!!"

    invoke-direct {p0, v3, v4}, Lcom/android/server/wm/WindowStateAnimator;->printInCallUILog(Lcom/android/server/wm/WindowState;Ljava/lang/String;)V
    ...
    const-string v5, "@@@prepareSurfaceLocked: w.mAttachedHidden = "

    invoke-virtual {v4, v5}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v4

    iget-boolean v5, v2, Lcom/android/server/wm/WindowState;->mAttachedHidden:Z

    invoke-virtual {v4, v5}, Ljava/lang/StringBuilder;->append(Z)Ljava/lang/StringBuilder;

    move-result-object v4

    const-string v5, ", w.isOnScreen() = "
    ...
    const-string v5, "@@@prepareSurfaceLocked: mLastHidden = "
...
.method showSurfaceRobustlyLocked()Z
    ...
    const-string v5, "@@@showSurfaceRobustlyLocked: mWin.mTurnOnScreen = "
    ...
    iget-boolean v5, v5, Lcom/android/server/wm/WindowState;->mTurnOnScreen:Z
    ...
    const-string v5, "@@@showSurfaceRobustlyLocked: Show surface turning screen on: "
    ...
    const-string v4, "Failure showing surface mSurfaceControl is null! "
