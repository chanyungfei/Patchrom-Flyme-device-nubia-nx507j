...
.field private static final ACTION_PAUSED:Ljava/lang/String; = "android.server.display.wfd.PAUSED"

.field private static final ACTION_RESUMED:Ljava/lang/String; = "android.server.display.wfd.RESEUMED"
...
.field private final mNotificationHandler:Lcom/android/server/display/WfdNotificationHandler;
...
.method public constructor <init>(Lcom/android/server/display/DisplayManagerService$SyncRoot;Landroid/content/Context;Landroid/os/Handler;Lcom/android/server/display/DisplayAdapter$Listener;Lcom/android/server/display/PersistentDataStore;)V
    ...
    .line 106
    new-instance v0, Lcom/android/server/display/WfdNotificationHandler;

    invoke-virtual {p3}, Landroid/os/Handler;->getLooper()Landroid/os/Looper;

    move-result-object v1

    invoke-direct {v0, p2, v1}, Lcom/android/server/display/WfdNotificationHandler;-><init>(Landroid/content/Context;Landroid/os/Looper;)V

    iput-object v0, p0, Lcom/android/server/display/WifiDisplayAdapter;->mNotificationHandler:Lcom/android/server/display/WfdNotificationHandler;
...
.method static synthetic access$1000(Lcom/android/server/display/WifiDisplayAdapter;)Lcom/android/server/display/PersistentDataStore;
    .locals 1
    .param p0, "x0"    # Lcom/android/server/display/WifiDisplayAdapter;
...
.method static synthetic access$500(Lcom/android/server/display/WifiDisplayAdapter;)Landroid/hardware/display/WifiDisplay;
    .locals 1
    .param p0, "x0"    # Lcom/android/server/display/WifiDisplayAdapter;
...
.method static synthetic access$502(Lcom/android/server/display/WifiDisplayAdapter;Landroid/hardware/display/WifiDisplay;)Landroid/hardware/display/WifiDisplay;
    .locals 0
    .param p0, "x0"    # Lcom/android/server/display/WifiDisplayAdapter;
    .param p1, "x1"    # Landroid/hardware/display/WifiDisplay;
...
.method static synthetic access$600(Lcom/android/server/display/WifiDisplayAdapter;)Lcom/android/server/display/WfdNotificationHandler;
    .locals 1
    .param p0, "x0"    # Lcom/android/server/display/WifiDisplayAdapter;

    .prologue
    .line 62
    iget-object v0, p0, Lcom/android/server/display/WifiDisplayAdapter;->mNotificationHandler:Lcom/android/server/display/WfdNotificationHandler;
