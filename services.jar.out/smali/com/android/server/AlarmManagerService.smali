...
.method setImpl(IJJJLandroid/app/PendingIntent;ZLandroid/os/WorkSource;Landroid/app/AlarmManager$AlarmClockInfo;)V
    ...
    .line 764
    .local v26, "creatorUid":I
    invoke-static/range {v26 .. v27}, Lnubia/os/ApplicationManager$Trigger;->allowWakeupAlarm(ILjava/lang/String;)Z
    ...
    .line 772
    :cond_4
    sget-boolean v8, Lcn/nubia/server/ApplicationManagerConfig;->DEBUG:Z

    if-eqz v8, :cond_5

    .line 773
    const-string v8, "ApplicationManagerService"

    new-instance v9, Ljava/lang/StringBuilder;

    invoke-direct {v9}, Ljava/lang/StringBuilder;-><init>()V

    const-string v10, "prevent a wakeup alarm acquire, pkg = "
    ...
    .line 808
    .end local v28    # "currentTime":J
    .end local v34    # "triggerRealTime":J
    :goto_1
    ...
    .line 796
    .restart local v28    # "currentTime":J
    .restart local v34    # "triggerRealTime":J
    :cond_d
    new-instance v8, Ljava/lang/StringBuilder;
