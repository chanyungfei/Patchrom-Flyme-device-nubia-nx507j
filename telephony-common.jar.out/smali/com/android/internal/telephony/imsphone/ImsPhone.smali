...
.field protected static final EVENT_GET_CALL_BARRING_DONE:I = 0x2f

.field protected static final EVENT_GET_CALL_WAITING_DONE:I = 0x31

.field protected static final EVENT_GET_CLIR_DONE:I = 0x33

.field protected static final EVENT_SET_CALL_BARRING_DONE:I = 0x2e

.field protected static final EVENT_SET_CALL_WAITING_DONE:I = 0x30

.field protected static final EVENT_SET_CLIR_DONE:I = 0x32
...
.method constructor <init>(Landroid/content/Context;Lcom/android/internal/telephony/PhoneNotifier;Lcom/android/internal/telephony/Phone;)V
    ...
    .line 144
    iput-boolean v2, p0, Lcom/android/internal/telephony/imsphone/ImsPhone;->mIsVideoCapable:Z
    ...
    invoke-interface {v1, p0, v2, v3}, Lcom/android/internal/telephony/CommandsInterface;->registerForVoiceNetworkStateChanged(Landroid/os/Handler;ILjava/lang/Object;)V
...
.method public handleMessage(Landroid/os/Message;)V
    ...
    const-string v15, "handleMessage what="
    ...
    const-string v14, "no LTE not display ims icon"
    ...
    invoke-virtual {v0, v13}, Lcom/android/internal/telephony/imsphone/ImsPhone;->updateImsIcon(Z)V
    ...
    invoke-direct {v0, v13}, Lcom/android/internal/telephony/imsphone/ImsPhone;->sendImsNetworkStateBroadcast(Z)V
    ...
    const-string v14, "LTE display ims icon"

    invoke-static {v13, v14}, Landroid/telephony/Rlog;->d(Ljava/lang/String;Ljava/lang/String;)I

    .line 1318
    invoke-virtual/range {p0 .. p0}, Lcom/android/internal/telephony/imsphone/ImsPhone;->isImsRegistered()Z
    ...
    invoke-virtual {v0, v14, v15}, Lcom/android/internal/telephony/imsphone/ImsPhone;->obtainMessage(ILjava/lang/Object;)Landroid/os/Message;
    ...
    iget-object v13, v0, Lcom/android/internal/telephony/imsphone/ImsPhone;->mContext:Landroid/content/Context;

    invoke-static {}, Landroid/telephony/SubscriptionManager;->getDefaultDataSubId()I

    move-result v14

    invoke-static {v13, v14}, Lcom/android/ims/ImsManager;->getInstance(Landroid/content/Context;I)Lcom/android/ims/ImsManager;

    move-result-object v7

    .line 1334
    .local v7, "mImsMgr":Lcom/android/ims/ImsManager;
    if-eqz v7, :cond_0
    ...
    invoke-static {v13}, Lcom/android/ims/ImsManager;->isEnhanced4gLteModeSettingEnabledByUser(Landroid/content/Context;)Z

    move-result v13

    invoke-virtual {v7, v13}, Lcom/android/ims/ImsManager;->setAdvanced4GMode(Z)V
    :try_end_0
    .catch Lcom/android/ims/ImsException; {:try_start_0 .. :try_end_0} :catch_0
    ...
    .line 1344
    .end local v7    # "mImsMgr":Lcom/android/ims/ImsManager;
    :sswitch_4
    ...
    .line 1346
    .local v2, "cf":Lcom/android/internal/telephony/imsphone/ImsPhone$Cf;
    iget-boolean v13, v2, Lcom/android/internal/telephony/imsphone/ImsPhone$Cf;->mIsCfu:Z
    ...
    invoke-virtual {v0, v13}, Lcom/android/internal/telephony/imsphone/ImsPhone;->setCallForwardingPreference(Z)V
    ...
    :goto_2
    iget-object v15, v2, Lcom/android/internal/telephony/imsphone/ImsPhone$Cf;->mSetCfNumber:Ljava/lang/String;

    invoke-virtual {v8, v14, v13, v15}, Lcom/android/internal/telephony/uicc/IccRecords;->setVoiceCallForwardingFlag(IZLjava/lang/String;)V

    .line 1350
    :cond_2
    iget-object v13, v2, Lcom/android/internal/telephony/imsphone/ImsPhone$Cf;->mOnComplete:Landroid/os/Message;
    ...
    invoke-direct {v0, v13, v14, v15}, Lcom/android/internal/telephony/imsphone/ImsPhone;->sendResponse(Landroid/os/Message;Ljava/lang/Object;Ljava/lang/Throwable;)V

    .line 1351
    invoke-virtual/range {p0 .. p0}, Lcom/android/internal/telephony/imsphone/ImsPhone;->updateCallForwardStatus()V
    ...
    .line 1355
    .end local v2    # "cf":Lcom/android/internal/telephony/imsphone/ImsPhone$Cf;
    ...
    check-cast v13, [Lcom/android/ims/ImsCallForwardInfo;

    check-cast v13, [Lcom/android/ims/ImsCallForwardInfo;

    move-object/from16 v0, p0

    invoke-direct {v0, v13}, Lcom/android/internal/telephony/imsphone/ImsPhone;->handleCfQueryResult([Lcom/android/ims/ImsCallForwardInfo;)[Lcom/android/internal/telephony/CallForwardInfo;
    ...
    invoke-direct {v0, v13, v4, v14}, Lcom/android/internal/telephony/imsphone/ImsPhone;->sendResponse(Landroid/os/Message;Ljava/lang/Object;Ljava/lang/Throwable;)V
    ...
    .line 1365
    .local v5, "cft":Lcom/android/internal/telephony/imsphone/ImsPhone$Cf;
    iget-object v13, v5, Lcom/android/internal/telephony/imsphone/ImsPhone$Cf;->mOnComplete:Landroid/os/Message;
    ...
    .line 1370
    .end local v5    # "cft":Lcom/android/internal/telephony/imsphone/ImsPhone$Cf;
    :sswitch_7
    const/4 v10, 0x0
    ...
    check-cast v13, [Lcom/android/ims/ImsSsInfo;

    check-cast v13, [Lcom/android/ims/ImsSsInfo;

    move-object/from16 v0, p0

    invoke-direct {v0, v13}, Lcom/android/internal/telephony/imsphone/ImsPhone;->handleCbQueryResult([Lcom/android/ims/ImsSsInfo;)[I
    ...
    invoke-direct {v0, v13, v10, v14}, Lcom/android/internal/telephony/imsphone/ImsPhone;->sendResponse(Landroid/os/Message;Ljava/lang/Object;Ljava/lang/Throwable;)V
    ...
    invoke-direct {v0, v13}, Lcom/android/internal/telephony/imsphone/ImsPhone;->handleCwQueryResult([Lcom/android/ims/ImsSsInfo;)[I
    ...
    .line 1383
    .local v9, "ssInfo":Landroid/os/Bundle;
    const/4 v6, 0x0
    ...
    .line 1385
    const-string v13, "queryClir"

    invoke-virtual {v9, v13}, Landroid/os/Bundle;->getIntArray(Ljava/lang/String;)[I
    ...
    invoke-direct {v0, v13, v6, v14}, Lcom/android/internal/telephony/imsphone/ImsPhone;->sendResponse(Landroid/os/Message;Ljava/lang/Object;Ljava/lang/Throwable;)V

    goto/16 :goto_0

    .line 1393
    .end local v6    # "clirInfo":[I
    .end local v9    # "ssInfo":Landroid/os/Bundle;
    :sswitch_9
    iget-object v13, v1, Landroid/os/AsyncResult;->userObj:Ljava/lang/Object;
    ...
    .line 1397
    :sswitch_a
    invoke-virtual/range {p0 .. p0}, Lcom/android/internal/telephony/imsphone/ImsPhone;->getCallForwardingPreference()Z

    move-result v3

    .line 1398
    .local v3, "cfEnabled":Z
    const-string v13, "ImsPhone"
    ...
    .line 1399
    invoke-virtual/range {p0 .. p0}, Lcom/android/internal/telephony/imsphone/ImsPhone;->notifyCallForwardingIndicator()V

    goto/16 :goto_0

    .line 1403
    .end local v3    # "cfEnabled":Z
    :sswitch_b
    const-string v13, "ImsPhone"

    const-string v14, "EVENT_DEFAULT_PHONE_DATA_STATE_CHANGED"
