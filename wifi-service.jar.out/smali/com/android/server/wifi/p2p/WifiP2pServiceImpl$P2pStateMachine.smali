...
.method private notifyInvitationReceived()V
    ...
    iget-object v7, v8, Landroid/net/wifi/p2p/WifiP2pConfig;->wps:Landroid/net/wifi/WpsInfo;
    ...
    const-string v9, "auto connect setup "

    invoke-virtual {v8, v9}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v8

    iget v9, v7, Landroid/net/wifi/WpsInfo;->setup:I

    invoke-virtual {v8, v9}, Ljava/lang/StringBuilder;->append(I)Ljava/lang/StringBuilder;

    move-result-object v8

    const-string v9, " save config addr "
    ...
    const-string v9, " mBeamDeviceAddress "
    ...
    invoke-static {v9}, Lcom/android/server/wifi/p2p/WifiP2pServiceImpl;->access$13400(Lcom/android/server/wifi/p2p/WifiP2pServiceImpl;)Ljava/lang/String;
    ...
    # getter for: Lcom/android/server/wifi/p2p/WifiP2pServiceImpl;->mBeamDeviceAddress:Ljava/lang/String;
    invoke-static {v8}, Lcom/android/server/wifi/p2p/WifiP2pServiceImpl;->access$13400(Lcom/android/server/wifi/p2p/WifiP2pServiceImpl;)Ljava/lang/String;
    ...
    invoke-static {v8, v10}, Lcom/android/server/wifi/p2p/WifiP2pServiceImpl;->access$13402(Lcom/android/server/wifi/p2p/WifiP2pServiceImpl;Ljava/lang/String;)Ljava/lang/String;

    .line 2434
    const v8, 0x23002

    invoke-virtual {p0, v8}, Lcom/android/server/wifi/p2p/WifiP2pServiceImpl$P2pStateMachine;->sendMessage(I)V
    ...
    .line 2445
    .local v6, "wifiP2pTitle":Landroid/widget/TextView;
    const v8, 0x10404db
    ...
    invoke-direct {p0, v1, v8, v9}, Lcom/android/server/wifi/p2p/WifiP2pServiceImpl$P2pStateMachine;->addRowToDialog(Landroid/view/ViewGroup;ILjava/lang/String;)V
    ...
    # getter for: Lcom/android/server/wifi/p2p/WifiP2pServiceImpl;->mContext:Landroid/content/Context;
    invoke-static {v9}, Lcom/android/server/wifi/p2p/WifiP2pServiceImpl;->access$600(Lcom/android/server/wifi/p2p/WifiP2pServiceImpl;)Landroid/content/Context;

    move-result-object v9

    invoke-direct {v8, v9}, Landroid/app/AlertDialog$Builder;-><init>(Landroid/content/Context;)V

    invoke-virtual {v8, v2}, Landroid/app/AlertDialog$Builder;->setCustomTitle(Landroid/view/View;)Landroid/app/AlertDialog$Builder;
    ...
    new-instance v10, Lcom/android/server/wifi/p2p/WifiP2pServiceImpl$P2pStateMachine$5;

    invoke-direct {v10, p0, v7, v3}, Lcom/android/server/wifi/p2p/WifiP2pServiceImpl$P2pStateMachine$5;-><init>(Lcom/android/server/wifi/p2p/WifiP2pServiceImpl$P2pStateMachine;Landroid/net/wifi/WpsInfo;Landroid/widget/EditText;)V
    ...
    new-instance v10, Lcom/android/server/wifi/p2p/WifiP2pServiceImpl$P2pStateMachine$4;

    invoke-direct {v10, p0}, Lcom/android/server/wifi/p2p/WifiP2pServiceImpl$P2pStateMachine$4;-><init>(Lcom/android/server/wifi/p2p/WifiP2pServiceImpl$P2pStateMachine;)V
    ...
    invoke-direct {v8, p0}, Lcom/android/server/wifi/p2p/WifiP2pServiceImpl$P2pStateMachine$6;-><init>(Lcom/android/server/wifi/p2p/WifiP2pServiceImpl$P2pStateMachine;)V

    invoke-virtual {v0, v8}, Landroid/app/AlertDialog;->setOnKeyListener(Landroid/content/DialogInterface$OnKeyListener;)V
    ...
    const-string v8, "Shown pin section visible"
