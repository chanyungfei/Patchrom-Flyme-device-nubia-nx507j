.class public Lcn/nubia/internal/policy/impl/smartface/util/SysPropUtils;
...
.method static constructor <clinit>()V
    ...
    sput v0, Lcn/nubia/internal/policy/impl/smartface/util/SysPropUtils;->singleStatus:I
...
.method public static dealSingleUI(Landroid/content/Context;Z)V
    ...
    .prologue
    .line 154
    sget-boolean v0, Lcn/nubia/internal/policy/impl/smartface/util/SysPropUtils;->mIsSingleUIEnable:Z
    ...
    .line 156
    :cond_0
    invoke-static {p0, p1}, Lcn/nubia/internal/policy/impl/smartface/util/SysPropUtils;->setSingleUiMode(Landroid/content/Context;Z)V
...
.method public static disableHapticFeedback(Landroid/content/Context;)Z
    ...
    .prologue
    .line 92
    invoke-static {p0}, Lcn/nubia/internal/policy/impl/smartface/util/SysPropUtils;->isSmartFaceEnable(Landroid/content/Context;)Z

    move-result v0

    if-eqz v0, :cond_0

    invoke-static {p0}, Lcn/nubia/internal/policy/impl/smartface/util/SysPropUtils;->isSmartFaceFuncEnable(Landroid/content/Context;)Z
...
.method public static isSingleUIFunctionEnable(Landroid/content/Context;)Z
    ...
    .prologue
    .line 180
    invoke-static {p0}, Lcn/nubia/internal/policy/impl/smartface/util/SysPropUtils;->getSingleUiMode(Landroid/content/Context;)I
...
.method public static isSmartFaceEnable(Landroid/content/Context;)Z
    ...
    .prologue
    .line 49
    invoke-static {p0}, Lcn/nubia/internal/policy/impl/smartface/util/SysPropUtils;->getSmartFaceDisplayFlag(Landroid/content/Context;)I
...
.method public static isSmartFaceLatticeEnable(Landroid/content/Context;)Z
    ...
    invoke-static {v2, p0}, Lcn/nubia/internal/policy/impl/smartface/util/SysPropUtils;->hasFeature(Ljava/lang/String;Landroid/content/Context;)Z
...
.method public static setSingleUiMode(Landroid/content/Context;Z)V
    ...
    sget v2, Lcn/nubia/internal/policy/impl/smartface/util/SysPropUtils;->singleStatus:I
...
.method public static updateSingleUIFunction(Landroid/content/Context;)V
    ...
    .prologue
    .line 149
    invoke-static {p0}, Lcn/nubia/internal/policy/impl/smartface/util/SysPropUtils;->isSingleUIFunctionEnable(Landroid/content/Context;)Z

    move-result v0

    sput-boolean v0, Lcn/nubia/internal/policy/impl/smartface/util/SysPropUtils;->mIsSingleUIEnable:Z
